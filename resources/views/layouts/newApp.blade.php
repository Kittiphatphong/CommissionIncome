...
<div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
    ...
    <a href="{{route('dashboard')}}">
        <img alt="Logo" src="assets/media/logos/logo_crypto.png" width="60px"/>

        <span class="mt-5 font-weight-bold font-size-h6">@lang('Income')</span>
    </a>
    <!--end::Logo-->
    <!--begin::Toolbar-->
        ...
        <div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
            ...
            <div class="brand flex-column-auto" id="kt_brand">
                ...
                <a href="{{route('dashboard')}}" class="brand-logo">
                    <img alt="Logo" src="assets/media/logos/logo_crypto.png" width="60px"/>
                <p class="mt-4 font-weight-bold font-size-h6">@lang('Income')</p>
                </a>
                <!--end::Logo-->
                <!--begin::Toggle-->
            ...
            <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
                ...
                <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
                    ...
                    <ul class="menu-nav">
                        ...
                        <li class="menu-item menu-item-submenu @if (isset($list_trade_types) || isset($list_trades))menu-item-open menu-item-here @endif " aria-haspopup="true"
                            data-menu-toggle="hover">
                            <a href="javascript:;" class="menu-link menu-toggle">

                                <i class="menu-icon fas fa-chart-bar"></i>
                                <span class="menu-text">@lang('Trade')</span>
                            ...
                            <div class="menu-submenu">
                                ...
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item @isset($list_trade_types) menu-item-active @endisset"
                                        aria-haspopup="true">
                                        <a href="{{route('trade-type.index')}}" class="menu-link">
                                    ...
                                    <li class="menu-item @isset($list_trades) menu-item-active @endisset"
                                        aria-haspopup="true">
                                        <a href="{{route('trade.index')}}" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">@lang('Trade')</span>
...
{{--                        <li class="menu-item menu-item-submenu @if(isset($loan_categories) || isset($loan_products))menu-item-open menu-item-here @endif " aria-haspopup="true" data-menu-toggle="hover">--}}
{{--                            <a href="javascript:;" class="menu-link menu-toggle">--}}
{{--                                <i class="menu-icon fas fa-credit-card"></i>--}}
{{--                                <span class="menu-text">@lang('Loans')</span>--}}
{{--                                <i class="menu-arrow"></i>--}}
{{--                            </a>--}}
{{--                            <div class="menu-submenu">--}}
{{--                                <i class="menu-arrow"></i>--}}
{{--                                <ul class="menu-subnav">--}}
{{--                                    <li class="menu-item @isset($loan_categories) menu-item-active @endisset" aria-haspopup="true">--}}
{{--                                        <a href="" class="menu-link">--}}
{{--                                            <i class="menu-bullet menu-bullet-dot">--}}
{{--                                                <span></span>--}}
{{--                                            </i>--}}
{{--                                            <span class="menu-text">@lang('Loan categories')</span>--}}
{{--                                        </a>--}}
{{--                                    </li>--}}

{{--                                    <li class="menu-item @isset($loan_products) menu-item-active @endisset" aria-haspopup="true">--}}
{{--                                        <a href="" class="menu-link">--}}
{{--                                            <i class="menu-bullet menu-bullet-dot">--}}
{{--                                                <span></span>--}}
{{--                                            </i>--}}
{{--                                            <span class="menu-text">@lang('Loan products')</span>--}}
{{--                                        </a>--}}
{{--                                    </li>--}}
